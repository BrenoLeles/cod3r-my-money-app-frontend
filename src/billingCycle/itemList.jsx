...
import {FORM_BILLING_CYCLES} from "./billingCycleActions";
...
class ItemList extends Component {
	...
	add(index, item = {}) {
		if(!this.props.readOnly) {
			this.props.arrayInsert(FORM_BILLING_CYCLES, this.props.field, index, item)
		}
	}
	
	remove(index) {
		if(!this.props.readOnly && this.props.list.length > 1) {
			this.props.arrayRemove(FORM_BILLING_CYCLES, this.props.field, index -1)
		}
	}
